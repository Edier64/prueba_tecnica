...
/// @nodoc
@JsonSerializable()
class _$NameImpl extends _Name {
  _$NameImpl({required this.first, required this.last}) : super._();
...
abstract class _Name extends Name {
  factory _Name({required final String first, required final String last}) =
      _$NameImpl;
  _Name._() : super._();
